...
namespace Test01
{
    public class TestClass
    {
        ...
        public void Reduce_RemovesElementsLessThanFour()
        {
            ...
            List<int> result = testObject.ReduceLessThanFour(input);
        ...
        public void Reduce_RemovesElementsMoreThanTen()
        {
            ...
            List<int> result = testObject.RemovesElementsMoreThanTen(input);
        ...
        public void Reduce_RemovesDuplicateElements()
        {
            ...
            List<int> result = testObject.RemovesDuplicateElements(input);
        ...
        public void Reduce_ReturnsFirstFiveItems()
        {
            ...
            List<int> result = testObject.ReturnsFirstFiveItems(input);
